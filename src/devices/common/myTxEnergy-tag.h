 ...
 */
#ifndef __MYTXENERGY_TAG_H
#define __MYTXENERGY_TAG_H
...
class MyTxEnergyTag : public Tag
{
public:
	static TypeId GetTypeId (void);
	MyTxEnergyTag ();
	virtual ~MyTxEnergyTag ();
	/**
...
//	static uint32_t AllocateFlowId (void);
	...
	void SetTagDouble (double value);
