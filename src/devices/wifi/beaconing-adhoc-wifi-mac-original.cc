...
#include "beaconing-adhoc-wifi-mac-original.h"
...
NS_LOG_COMPONENT_DEFINE ("BeaconingAdhocWifiMacOriginal");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (BeaconingAdhocWifiMacOriginal);

TypeId
BeaconingAdhocWifiMacOriginal::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::BeaconingAdhocWifiMacOriginal")
    .SetParent<RegularWifiMac> ()
    .AddConstructor<BeaconingAdhocWifiMacOriginal> ()
	.AddAttribute ("BeaconLost", "The number of beacon lost to loose a neighbor",
                   UintegerValue (BEACON_LOST_RATIO),
                   MakeUintegerAccessor (&BeaconingAdhocWifiMacOriginal::m_numberBeaconLost),
                   MakeUintegerChecker<uint32_t> (1))
//%    .AddAttribute ("BeaconInterval", "Delay between two beacons",
//                       TimeValue (Seconds (1)),
//                       MakeTimeAccessor (&BeaconingAdhocWifiMacOriginal::GetBeaconInterval,
//                                         &BeaconingAdhocWifiMacOriginal::SetBeaconInterval),
//                       MakeTimeChecker ())
//    .AddAttribute ("BeaconGeneration", "Whether or not beacons are generated.",
//                       BooleanValue (true),
//                       MakeBooleanAccessor (&BeaconingAdhocWifiMacOriginal::SetBeaconGeneration,
//                                            &BeaconingAdhocWifiMacOriginal::GetBeaconGeneration),
//                       MakeBooleanChecker ())
      .AddTraceSource ("NeighborLost", "A neighbor is lost",
                   					 MakeTraceSourceAccessor (&BeaconingAdhocWifiMacOriginal::m_neighborLostTraceSource))
      .AddTraceSource ("NewNeighbor", "A neighbor is found",
                   					 MakeTraceSourceAccessor (&BeaconingAdhocWifiMacOriginal::m_newNeighborTraceSource))
  ;
  return tid;
}

BeaconingAdhocWifiMacOriginal::BeaconingAdhocWifiMacOriginal ()
{
  ...
  m_beaconEvent = Simulator::Schedule (t3, &BeaconingAdhocWifiMacOriginal::SendOneBeacon, this);
...
void
BeaconingAdhocWifiMacOriginal::SetAddress (Mac48Address address)
{
...
void
BeaconingAdhocWifiMacOriginal::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
BeaconingAdhocWifiMacOriginal::SetLinkUpCallback (Callback<void> linkUp)
{
  NS_LOG_FUNCTION (this);
...
void
BeaconingAdhocWifiMacOriginal::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
BeaconingAdhocWifiMacOriginal::SetBeaconGeneration (bool enable)
{
  NS_LOG_FUNCTION (this << enable);
  if (enable)
    {
      m_beaconEvent = Simulator::ScheduleNow (&BeaconingAdhocWifiMacOriginal::SendOneBeacon, this);
    }
  else
    {
...
bool
BeaconingAdhocWifiMacOriginal::GetBeaconGeneration (void) const
{
  return m_beaconEvent.IsRunning ();
}

void
BeaconingAdhocWifiMacOriginal::SendOneBeacon (void)
{
  DecreaseBeaconCount();
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
...
//  m_dca->Queue (packet, beacon);
  ...
  m_beaconEvent = Simulator::Schedule (Seconds(BEACON_INTERVAL), &BeaconingAdhocWifiMacOriginal::SendOneBeacon, this);


}
void BeaconingAdhocWifiMacOriginal::ProcessBeacon( Ptr<Packet> packet, Mac48Address addrFrom){
	...
	//std::cout<<Simulator::Now()<<GetAddress()<<" Incremento contador de  "<<addrFrom<<" a "<<m_neighborList[addrFrom]<<std::endl;

}

void BeaconingAdhocWifiMacOriginal::DecreaseBeaconCount(){
...
SupportedRates
BeaconingAdhocWifiMacOriginal::GetSupportedRates (void) const
{
