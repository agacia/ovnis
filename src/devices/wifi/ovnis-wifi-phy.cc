  ...
  switch (m_state->GetState ())
    ...
    case OvnisWifiPhy::IDLE:
      if (rxPowerW > m_edThresholdW)
        ...
        {
          NS_LOG_DEBUG ("drop packet because signal power too Small (" << m_rxPowerW << "<" << m_edThresholdW << ")");
          NotifyRxDrop (packet);
          goto maybeCcaBusy;
        }
      break;
...
//                   "this threshold (dbm) to allow the PHY layer to detect the signal.",
//                   DoubleValue (-96.0),
//                   MakeDoubleAccessor (&OvnisWifiPhy::SetEdThreshold,&OvnisWifiPhy::GetEdThreshold),
//                   MakeDoubleChecker<double> ())
//    .AddAttribute ("CcaMode1Threshold",
//                   "The energy of a received signal should be higher than "
//                   "this threshold (dbm) to allow the PHY layer to declare CCA BUSY state",
...
////{
////	return WifiPhy::CalculateTxDuration(size, payloadMode, preamble);
