 ...
 *
 * CommunityApplication.h
 *
 *  Created on: Mar 26, 2010
 *      Author: Yoann Pigné
 */

#ifndef COMMUNITYAPPLICATION_H_
#define COMMUNITYAPPLICATION_H_
...
namespace ns3
{
  ...
  class CommunityApplication : public OvnisApplication
  {
  public:
