...
#ifndef DSSAPPLICATION_H_
#define DSSAPPLICATION_H_
...
namespace ns3
{
  ...
  class DssApplication : public OvnisApplication
  {
  public:
  ...
  private:
    ...
    /**
     * A local VANET's database containing traffic information ONLY received from other vehicles
     */
